...
<div class="w-full px-4 my-6 h-fit md:px-32">
    <div class="w-full overflow-hidden rounded-md h-fit">
        ...
        <a href="https://skul.id/" target="_blank" class="flex items-center p-2 mx-auto mt-4 mb-6 font-bold uppercase transition bg-white border-2 rounded sm:mb-8 sm:border-4 sm:px-4 sm:py-3 sm:text-lg hover:bg-premier group hover:text-white whitespace-nowrap border-premier text-premier w-fit gap-x-3">
            Kunjungi Disini
            <div class="p-2 transition rounded group-hover:bg-white">
