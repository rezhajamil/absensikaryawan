...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 13, 2023 at 03:40 PM
...
(135, 'K2211001', 'Teguh Eka Syahputra', 9, 19, 15),
...
(48, '::1', 'bangrobin71@gmail.com', '$2y$12$rQBawtM6uZ5TNvZWE1HNl.8pEUU3rDUoGPpMiMXxkTv2zOez.oY0m', 'bangrobin71@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1656751712, 1673618127, 1, 'Robin', 'Irawan', 'Nama Perusahaan', '081283328655'),
...
--
ALTER TABLE `gedung`
  MODIFY `gedung_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `shift`
  MODIFY `id_shift` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
